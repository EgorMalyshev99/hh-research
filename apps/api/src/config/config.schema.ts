...
export const configSchema = z.object({
  ...
  TRUDVSEM_API_BASE: z.string().url().default('https://opendata.trudvsem.ru/api/v1'),
  SUPERJOB_API_BASE: z.string().url().default('https://api.superjob.ru/2.0'),
  SUPERJOB_APP_ID: z.string().optional(),
  VACANCY_IMPORT_MAX_LIMIT: z.coerce.number().int().min(1).max(500).default(200),
